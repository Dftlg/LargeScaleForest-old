...
#include "../RenderingProcess/Shader.h"2
...
int main()
{
	...
	//vFem.readDeformationDataByMutileThread("D:\\GraduationProject\\Vega\\models\\8.10\\test\\positionthe0phi0force500,500,500.txt");
	...
	CShader ourShader("D://GraduationProject//Vega//VegaInterpolationRendering//Tree.vert", "D://GraduationProject//Vega//VegaInterpolationRendering//Tree.frag");
	...
	/*	std::cout << "间隔时间" << DeltaTime << std::endl;*/
		...
		for (int j = 0; j < numbercounter; j++)
		{
			...
			ourModel.AddDeformationGroups(temp);

...
public:
	...
	void searchMatchedFrameSequences(std::vector<std::vector<int>> &voExtraForces, std::vector<std::vector<Common::SWindDirecetion>> &vForceDirection);
...
private:
	...
	//spKVF文件的受力方向
	std::vector<std::pair<int, std::vector<Common::SWindDirecetion>>> m_WindDirectionSequence;
	//SpKVF的段索引号，当前索引下K矩阵

...
int main()
{
	...
	std::string vegFilePath = "D:/GraduationProject/LargeScaleForest/models/apricot_tree/tree.veg";
	//std::string objFilePath = "D:/GraduationProject/LargeScaleForest/models/apricot_tree/find_lost.obj";
